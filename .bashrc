...
if [[ "$dev" =~ "$(uname -n)" ]]; then
    ...
    alias cont2="CONTAINER_NAME=cont2 XTERNAL_GIT_DIR="${HOME}/immunai-product" EXTERNAL_DATA_DIR="${HOME}/data" immunai-product/modules/containers/docker_root/analysis/bin/start-container"
    alias rf="readlink -f"
